...
export const productFormConfig: ResourceFormConfig<ProductFormValues> = {
  ...
  fields: [
    ...
    { name: 'current_price', label: "Hozirgi narxi (so'm)", type: 'number' },
    {
      ...
      type: 'number',
      help: 'Ixtiyoriy — chegirmani ko\'rsatish uchun. Bo\'sh qoldiring, chegirma bo\'lmasa.',
    },
    { name: 'is_top', label: "Bu oyning top mahsuloti", type: 'checkbox' },
    { name: 'top_order', label: 'Top ro\'yxatdagi o\'rni', type: 'number' },
    { name: 'top_note', label: 'Top izohi', type: 'text' },
  ],
  defaultValues: {
    name: '',
    description: '',
