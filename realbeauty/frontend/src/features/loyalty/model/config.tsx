...
export const loyaltySettingsFormConfig: ResourceFormConfig<LoyaltySettingsFormValues> = {
  ...
  fields: [
    ...
    { name: 'points_registration', label: "Ro'yxatdan o'tgani uchun (ball)", type: 'number' },
    { name: 'points_referral', label: "Do'st taklif qilgani uchun (ball)", type: 'number' },
    ...
    { name: 'bronze_cashback', label: 'Bronza keshbek (%)', type: 'number' },
...
export const rewardFormConfig: ResourceFormConfig<RewardFormValues> = {
  ...
  fields: [
    ...
    { name: 'title_ru', label: 'Nomi (ruscha)', type: 'text' },
    { name: 'title_en', label: 'Nomi (inglizcha)', type: 'text' },
    { name: 'description', label: 'Tavsif', type: 'textarea' },
    { name: 'cost_points', label: 'Narxi (ball)', type: 'number' },
    { name: 'code_prefix', label: 'Promokod boshlanishi', type: 'text', help: 'Masalan: RB' },
    { name: 'stock', label: 'Nechta qoldi', type: 'text', help: "Bo'sh — cheklanmagan" },
